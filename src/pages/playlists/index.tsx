        ...
        <Row className={styles.list} gutter={[24, 24]}>
          {playlists.map((item: Playlist) => (
            <Col key={item.id} span={8}>
              <div className={styles.item} onClick={() => router.push('/playlists/' + item.id + '/')}>
                <div
                ...
                <div className={styles.meta}>
                  <div className={styles.info}>
                    <Typography.Text className={styles.name}>{item.name}</Typography.Text>
                    <Typography.Text className={styles.authors}>{getPlaylistDescription(item)}</Typography.Text>
                  </div>
