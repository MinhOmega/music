            ...
            <div className={styles.searchResultItem}>
              ...
              >
                ...
                <div className={styles.searchResultItemMeta}>
                  <div className={styles.searchResultItemTitle}>{item.title?.text}</div>
                  <div className={styles.searchResultItemTimer}>{formatTime(item.duration.seconds || 0)}</div>
                </div>
              </div>
                ...
                <div className={optionItems ? styles.itemRevealableControls : ''}>
                  ...
                  {optionItems && (
                    <Dropdown
                      ...
                      arrow
                    >
                      <Button icon={<FontAwesomeIcon icon={faEllipsisVertical} />} shape={'circle'} type={'text'} />
                    </Dropdown>
                  )}
                </div>
              </div>
