...
export default function AddTrackToPlaylistModal() {
  ...
  return (
    <Modal open={addToPlaylistModal.showModal} title={null} footer={false} onCancel={closeModal}>
      {addToPlaylistModal.showModal && addToPlaylistModal.track && (
        <div className={styles.header}>
          ...
          <div className={styles.meta}>
            <Typography.Text className={styles.title}>{addToPlaylistModal.track.title.text}</Typography.Text>
      ...
      <List
        ...
        renderItem={(item) => (
          <div className={styles.item} onClick={(_) => toggleItem(item.id)}>
            ...
            <div className={styles.meta}>
              ...
              <div className={styles.description}>{item.tracks.length} tracks</div>
            </div>
          </div>
        )}
      />
