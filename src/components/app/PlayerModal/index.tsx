...
export default function PlayerModal() {
  ...
  const { openModal, queue, playingIndex, currentTime, paused, loading, repeatMode, shuffle } = useAppSelector(
    (state) => state.player
  )
  ...
  return (
    <div className={styles.playerOuter + ` ${openModal ? styles.open : ''}`}>
      <div
      ...
      <div className={styles.meta}>
        <div className={styles.info}>
          <Typography.Text className={styles.title}>{currentTrack.title.text}</Typography.Text>
          <Typography.Text className={styles.author}>{currentTrack.author.name}</Typography.Text>
        </div>
      ...
      <div className={styles.playerControls}>
        ...
        <div className={styles.timer}>
          <Typography.Text className={styles.time}>{formatTime(currentTime)}</Typography.Text>
          <Typography.Text className={styles.time}>{formatTime(currentTrack.duration.seconds)}</Typography.Text>
        </div>
        ...
        <div className={styles.controlButtons}>
          ...
          >
            <FontAwesomeIcon
              ...
              style={{
                color:
                  repeatMode === RepeatMode.REPEAT_ALL || repeatMode === RepeatMode.REPEAT_ONE ? colorPrimary : 'white',
              }}
            />
          ...
          <a className={styles.small} onClick={() => dispatch(prevTrack())}>
          ...
          <a className={styles.small} onClick={() => dispatch(nextTrack())}>
