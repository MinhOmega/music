...
export default function Conversation() {
  ...
  return (
    <div className={styles.outer}>
          ...
          renderItem={(item) => {
            return (
              <Comment
                ...
                author={<Typography.Text className={styles.name}>{item.author}</Typography.Text>}
                datetime={
                  <Typography.Text className={styles.date}>{dayjs(item.timestamp).format('HH:mm')}</Typography.Text>
                }
              />
            )
          }}
      ...
      <Form form={form} className={styles.form} onFinish={sendMessage}>
