...
export default function AudioControlModal() {
  ...
  return (
    <div className={styles.outer + ` ${audioControlModal ? styles.show : ''}`} onClick={close}>
      <div
      ...
      >
        ...
        <Typography.Text>Audio Level</Typography.Text>
        <Slider
          value={volumeLevel}
          step={1}
          min={0}
        ...
        <div className={styles.sectionTitle}>
          <Typography.Text>
            <FontAwesomeIcon icon={faHeadphones} /> Output Device
          </Typography.Text>
        ...
        <Typography.Text className={styles.credit}>
          {/* Made with love by <a href={'https://delimister.com'}>@delimister</a> (a.k.a @MinhOmega) */}
        </Typography.Text>
      </div>
    </div>
  )
