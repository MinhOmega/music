          ...
          onDragEnd={(result, provided) => {
            ...
            dispatch(
              setPlayer({
                queue: newQueue,
                playingIndex:
                  result.destination.index === playingIndex
                    ? result.source.index
                    : result.source.index === playingIndex
                    ...
                    {(provided) => (
                      ...
                      >
                        ...
                        <div className={styles.itemMeta + ` ${playingIndex === index ? styles.active : ''}`}>
                          <Typography.Text className={styles.title}>{item.title.text}</Typography.Text>
                          <Typography.Text className={styles.author}>{item.author.name}</Typography.Text>
                        </div>
